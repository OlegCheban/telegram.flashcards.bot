...
public class EnableExcerciseCommand extends BotCommand {
    ...
    public EnableExcerciseCommand(String commandIdentifier, String description, DataLayerObject dataLayerObject) {
    ...
    public void processMessage(AbsSender absSender, Message message, String[] arguments) {
        ...
        List<ExerciseKind> exerciseKinds  = dataLayer.getExerciseKindToEnable(chatId);
