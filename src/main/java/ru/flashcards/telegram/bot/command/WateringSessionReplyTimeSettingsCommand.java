...
public class WateringSessionReplyTimeSettingsCommand extends BotCommand {
    private DataLayerObject dataLayer;

    public WateringSessionReplyTimeSettingsCommand(String commandIdentifier, String description, DataLayerObject dataLayerObject) {
