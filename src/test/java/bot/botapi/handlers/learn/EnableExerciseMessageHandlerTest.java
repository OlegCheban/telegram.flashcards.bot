...
public class EnableExerciseMessageHandlerTest {
    @Mock
    ...
    @WeldSetup
    private WeldInitiator weld = WeldInitiator.from(EnableExerciseMessageHandler.class, EnableExerciseMessageHandlerTest.class).build();
