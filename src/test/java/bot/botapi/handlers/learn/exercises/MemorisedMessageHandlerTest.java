...
import ru.flashcards.telegram.bot.botapi.handlers.learn.exercises.MemorisedMessageHandler;
...
public class MemorisedMessageHandlerTest {
    @Mock
    private Message message;

    @WeldSetup
    private WeldInitiator weld = WeldInitiator.from(MemorisedMessageHandler.class, MemorisedMessageHandlerTest.class).build();
    ...
    void test(){
        ...
        List<BotApiMethod<?>> list = weld.select(MemorisedMessageHandler.class).get().handle(message);
