...
import static ru.flashcards.telegram.bot.botapi.BotKeyboardButton.ADD_TO_LEARN;
...
public class AddToLearnCallbackHandlerTest {
    ...
    @WeldSetup
    private WeldInitiator weld = WeldInitiator.from(AddToLearnCallbackHandler.class, AddToLearnCallbackHandlerTest.class).build();
    ...
    void test() throws Exception {
        ...
        List<BotApiMethod<?>> list = weld.select(AddToLearnCallbackHandler.class).get().handle(callbackQuery);
